...
public:
     ...
     * @param init_min Minimum initial search distance
     * @param init_max Maximum initial search distance  
     * @param subsequent_dist Max distance for subsequent ORF searches (default 50bp, searches from 0 to this value)
