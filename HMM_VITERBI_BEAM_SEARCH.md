...
This implementation combines **Viterbi alignment** with **beam search** to find optimal paths through a de Bruijn graph that match a profile HMM. The system translates DNA sequences to amino acids and scores them using HMMER3-compatible log-odds scoring.
